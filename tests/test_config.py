...
class TestCopyNoMatchToClipboardConfig(unittest.TestCase):
    """Test cases for copy_no_match_to_clipboard configuration setting."""
...
"""
        ...
        config = Config(str(self.config_path))
        self.assertFalse(config.get_copy_no_match_to_clipboard())

    def test_copy_no_match_to_clipboard_true(self):
        """Test copy_no_match_to_clipboard set to true."""
        config_content = """
...
"""
        ...
        config = Config(str(self.config_path))
        self.assertTrue(config.get_copy_no_match_to_clipboard())

    def test_copy_no_match_to_clipboard_false(self):
        """Test copy_no_match_to_clipboard explicitly set to false."""
        config_content = """
copy_no_match_to_clipboard = false
...
"""
    ...
    def test_copy_no_match_to_clipboard_invalid_integer(self):
        """Test copy_no_match_to_clipboard with integer value raises SystemExit."""
        config_content = """
copy_no_match_to_clipboard = 1
"""
        self.config_path.write_text(config_content)
    ...
    def test_copy_no_match_to_clipboard_invalid_string(self):
        """Test copy_no_match_to_clipboard with string value raises SystemExit."""
        config_content = """
copy_no_match_to_clipboard = "yes"
"""
        self.config_path.write_text(config_content)
    ...
    def test_copy_no_match_to_clipboard_reload_on_config_change(self):
        """Test that copy_no_match_to_clipboard is reloaded when config file changes."""
        config_content = """
copy_no_match_to_clipboard = false
...
"""
        ...
        # Modify config file to enable the feature
        new_content = """
copy_no_match_to_clipboard = true
