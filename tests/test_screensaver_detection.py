...
class TestScreensaverDetection(unittest.TestCase):
    ...
    def test_screensaver_detection_empty_title(self, mock_get_title):
        """Test screensaver detection with empty window title."""
        result = WindowMonitor.is_screensaver_active()
        self.assertTrue(result)

    @patch("src.window_monitor.WindowMonitor.get_active_window_title", return_value="Google Chrome")
    def test_screensaver_detection_with_title(self, mock_get_title):
    ...
    def test_screensaver_detection_various_titles(self, mock_get_title):
        """Test screensaver detection with various window titles."""
        result = WindowMonitor.is_screensaver_active()
        self.assertFalse(result)
    ...
    def test_screensaver_detection_debug_mode(self, mock_get_title):
        ...
        result = WindowMonitor.is_screensaver_active(debug=True)
        self.assertTrue(result)
